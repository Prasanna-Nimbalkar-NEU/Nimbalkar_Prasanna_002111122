...
public class ViewPanel extends javax.swing.JPanel {
    ...
    public ViewPanel(EncounterHistory encounterHistoryList) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblEncounter.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Age", "Address", "Area", "City", "Temp.", "Blood Press.", "Pulse", "Resp. rate", "Weight"
            }
        ));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (txtPatient.getText().length()==0 || txtAge.getText().length()==0 || txtAddress.getText().length()==0 || txtArea.getText().length()==0 || txtCity.getText().length()==0 || txtTemp.getText().length()==0 || txtBP.getText().length()==0 || txtPulse.getText().length()==0 || txtRR.getText().length()==0 || txtWeight.getText().length()==0){
            ...
            Encounter enc = encounterHistoryList.updateEncounter(selectedRowIndex);
    ...
    private void tblEncounterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEncounterMouseClicked
        ...
        Encounter encounterData = (Encounter) model.getValueAt(selectedRowIndex, 0);
        
        txtPatient.setText(String.valueOf(encounterData.getVitalPatientInformation().getName()));
        txtAge.setText(String.valueOf(encounterData.getVitalPatientInformation().getAge()));
        txtAddress.setText(String.valueOf(encounterData.getVitalPatientInformation().getHouse()));
        txtArea.setText(String.valueOf(encounterData.getVitalPatientInformation().getCommunity()));
        txtCity.setText(String.valueOf(encounterData.getVitalPatientInformation().getCity()));
        txtTemp.setText(String.valueOf(encounterData.getVitals().getTemperature()));
        txtBP.setText(String.valueOf(encounterData.getVitals().getBloodPressure()));
        txtPulse.setText(String.valueOf(encounterData.getVitals().getPulse()));
        txtRR.setText(String.valueOf(encounterData.getVitals().getRespiratoryRate()));
        txtWeight.setText(String.valueOf(encounterData.getVitals().getWeightInKilos()));
    ...
    private void btnDeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeleteMouseClicked
        ...
        encounterHistoryList.deleteEncounter(encounterData);
       
        
        JOptionPane.showMessageDialog(this, "Car Data has been deleated");
        populateTable();
    ...
    private void populateTable() {
        ...
        for (Encounter cd : encounterHistoryList.getEncounterHistoryList()){
